...
QT版本(最新)：
https://github.com/PlexVPN/plex/releases/download/qt.v5.1.0/Plex-Windows-Qt-v5.3.0.exe
...
## MAC：
https://github.com/PlexVPN/plex/releases/download/qt.v5.1.0/Plex-MacOS-Qt-v5.3.0.dmg

此安装包仅支持macOS/OS X 10.9+版本；

## UBUNTU：
https://github.com/PlexVPN/plex/releases/download/qt.v5.1.0/Plex-Ubuntu-Qt-v5.3.0.AppImage

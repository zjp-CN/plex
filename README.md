...
QT版本(最新)：
https://github.com/PlexVPN/plex/releases/download/qt.v5.5.2/Plex-Windows-Qt-v5.5.2.exe
...
## MAC：
https://github.com/PlexVPN/plex/releases/download/qt.v5.5.2/Plex-MacOS-Qt-v5.5.2.dmg
...
## UBUNTU：
https://github.com/PlexVPN/plex/releases/download/qt.v5.5.2/Plex-Ubuntu-Qt-v5.5.2.AppImage

此安装包支持Ubuntu LTS 14.04+版本；

## Android (PlexVPN - Best Premium Unlimited VPN Proxy)：
安卓4.4.3版本 https://github.com/PlexVPN/plex/releases/download/android.v4.4.3/Plex-Android-v4.4.3.apk
...
安卓TV1.1.0版本 https://github.com/PlexVPN/plex/releases/download/androidtv.v2.0.0/Plex-AndroidTV-v2.0.0.apk
...
用户名：plexv5@outlook.com密码：Plexuser1

用户名：plexv4@outlook.com密码：Plexuser2

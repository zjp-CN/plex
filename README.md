...
QT版本：
https://github.com/PlexVPN/plex/releases/download/qt.v5.0.2/PlexQt_Setup_5.0.2.exe
...
## Mac端请点击以下链接：
https://github.com/PlexVPN/plex/releases/download/qt.v5.0.2/PlexQt_5.0.2.dmg

此安装包仅支持macOS/OS X 10.9+版本；

## Android端请点击以下链接：
安卓3.7.8版本 https://github.com/PlexVPN/plex/releases/download/android.v3.7.8/Plex-Android-v3.7.8.apk

...
QT版本(最新)：
https://github.com/PlexVPN/plex/releases/download/qt.v6.0.0/Plex-Windows-Qt-v6.0.0.exe
...
## MAC：
此安装包仅支持macOS/OS X 10.12+版本：https://github.com/PlexVPN/plex/releases/download/qt.v6.0.0/Plex-MacOS-Qt-v6.0.0.dmg
...
## UBUNTU：
https://github.com/PlexVPN/plex/releases/download/qt.v6.0.0/Plex-Ubuntu-Qt-v6.0.0.AppImage

此安装包支持Ubuntu LTS 16.04+版本；

## Android (PlexVPN - Best Premium Unlimited VPN Proxy)：
安卓4.7.3版本 https://github.com/PlexVPN/plex/releases/download/android.v4.7.3/Plex-Android-v4.7.3.apk
...
用户名：plexv6@outlook.com密码：Plexuser3

用户名：plexv8@hotmail.com密码：Plexuser1
